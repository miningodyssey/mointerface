export function createSlideObstacle(scene, x, y, z,  modelCache) {
    try {
        ...
        const collisionBox = BABYLON.MeshBuilder.CreateBox("collisionBox", { width: 0.5, height: 2, depth: 0.6 }, scene);
        ...
        slideObstacleTop.position = new BABYLON.Vector3(0, 0, -0.2); // Относительное позиционирование
